...
public class FolderCreationParallel {
	
	Logger LOGGER = LogManager.getLogger(FolderCreationParallel.class);
	String REPORT_PATH = null;
	String SCREENSHOT_PATH = null;
	
	
	
	public String folderNameCreator() {
	 ...
	 */
	public boolean createDirectory(String path, String folderName) {
