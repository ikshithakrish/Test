...
public class Login2 {
	public static final Logger LOGGER = LogManager.getLogger(Login2.class);
		  ...
		  if(FolderCreation.createDirectory(tempPath, folderName) ) {
			...
			//copy the content of Header.txt to ../..Report.html
				if(HtmlCreator.copyFileContent(HtmlCreator.BUFFERED_WRITER, reportHeaderFile)) {
					...
					String destinationFile= actualPath + "\\Login.html";
					...
					HtmlCreator.findReplaceString(destinationFile, "Login");  // how to set it
