...
private static final Logger LOGGER = LogManager.getLogger(Registration_Test.class);
		  ...
		  if(FolderCreation.REPORT_PATH != null) {
			...
			//copy the content of Header.txt to ../..Report.html
				//if(HtmlCreator.copyFileContent(HtmlCreator.BUFFERED_WRITER, reportHeaderFile)) {
					...
					String destinationFile= actualPath + "\\Registration_Test.html";
					...
					HtmlCreator.findReplaceString(destinationFile, "Regisration_Test");  // how to set it
