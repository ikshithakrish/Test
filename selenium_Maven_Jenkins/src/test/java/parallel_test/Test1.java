...
//			    html_FileCreator_ref1.createSubReportFile(actualPath, fileName);  // HtmlCreator.BUFFERED_WRITER (Report.html)
//				  if(html_FileCreator_ref1.copyFileContent(html_FileCreator_ref1.BUFFERED_WRITER, sourceFile)) {
//					  LOGGER.info("Header content copied to the primary report");
//					  
//				  }
//		  
//				LOGGER.info("BufferedWriter reference is " + html_FileCreator_ref1.BUFFERED_WRITER);
